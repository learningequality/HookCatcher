...
You'll need a directory for storing data. You can either start from scratch with an empty directory, or use an existing database and image set. See <a href="https://github.com/MingDai/HookCatcherData" target="_blank">this repo </a> for example.
...
```
Add your Github <a href="https://help.github.com/articles/creating-a-personal-access-token-for-the-command-line/" target="_blank">personal access token</a>
```python
